...
public class Restaurant_PostDish extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_restaurant_post_dish);
    ...
    private void uploadImage() {
        ...
        if (imageuri != null) {
            final ProgressDialog progressDialog = new ProgressDialog(Restaurant_PostDish.this);
            ...
            ref.putFile(imageuri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            FoodSupplyDetails info = new FoodSupplyDetails(dishes, quantity, price, description, String.valueOf(uri), RandomUId, RestaurantId);
                            firebaseDatabase.getInstance().getReference("FoodSupplyDetails").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child(RandomUId)
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    ...
                                    Toast.makeText(Restaurant_PostDish.this, "Dish posted successfully", Toast.LENGTH_SHORT).show();
                                }
                            });
                        }
                    });
                ...
                public void onFailure(@NonNull Exception e) {
                    ...
                    progressDialog.dismiss();
                    Toast.makeText(Restaurant_PostDish.this, e.getMessage(), Toast.LENGTH_SHORT).show();
                }
