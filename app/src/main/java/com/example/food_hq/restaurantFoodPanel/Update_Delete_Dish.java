...
import com.example.food_hq.RestaurantFoodPanel_BottomNavigation;
...
public class Update_Delete_Dish extends AppCompatActivity {
    ...
    String description, quantity, price, dishes, RestaurantId;
    String RandomUId;
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                food.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        ...
                                        startActivity(new Intent(Update_Delete_Dish.this, RestaurantFoodPanel_BottomNavigation.class));
                                    }
                                });
    ...
    private void updatedesc(String uri) {
        ...
        FoodSupplyDetails info = new FoodSupplyDetails(dishes, quantity, price, description, uri, ID, RestaurantId);
