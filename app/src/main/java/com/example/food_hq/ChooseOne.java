...
public class ChooseOne extends AppCompatActivity {
    ...
    Button Restaurant, Customer, DeliveryPerson;
    Intent intent;
    String type;
        ...
        Restaurant.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (type.equals("Email")) {
                    Intent loginemail = new Intent(ChooseOne.this, RestaurantLogin.class);
                    startActivity(loginemail);
                    finish();
                }
                if (type.equals("Phone")) {
                    Intent loginphone = new Intent(ChooseOne.this, Restaurantloginphone.class);
                    startActivity(loginphone);
                    finish();
                }
                if (type.equals("SignUp")) {
                    Intent Register = new Intent(ChooseOne.this, RestaurantRegisteration.class);
